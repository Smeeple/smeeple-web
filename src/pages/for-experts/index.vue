...
<template>
    <section class="relative -mt-[141px] flex items-center bg-[#111111] bg-[url('/assets/img/bg-shapes-gray.png')] pb-0">
        <div class="container sm-max:pb-6 sm-max:pt-10 md:py-8 md-max:mt-6">
            <div class="sm:grid sm:grid-cols-12 xl:items-center xl:gap-9 2xl:gap-12">
                <div class="sm:col-span-12 xl:col-span-6">
                    ...
                    <p class="mt-3 text-white">Engage through 1:1 video chats, offer your insights and help, and capitalize on your skills. Set your own rates and availability. Smeeple not only enables you to leverage your existing network but also connects you with new opportunities.</p>
