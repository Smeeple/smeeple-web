...
<template>
    <section class="relative -mt-[141px] flex items-center bg-[#111111] bg-[url('/assets/img/bg-shapes-gray.png')] md-max:pb-0 lg:py-12">
    ...
    <section class="sm-max:pb-3 sm-max:pt-6 md:pb-3">
        <div class="container">
            ...
            <div class="mb-8 grid sm:grid-cols-12 xl:items-center xl:gap-12">
                ...
                <div class="sm:col-span-12 lg-max:text-center xl:col-span-10 xl:col-start-2 2xl:col-span-5">
