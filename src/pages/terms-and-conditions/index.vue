        ...
        <div class="container">
            <div class="sm:grid sm:grid-cols-12 sm:gap-3">
                <div class="sm:col-span-12 lg:col-span-10 lg:col-start-2 xl:col-span-8 xl:col-start-3">
                    ...
                    <p>Please refer to the Smeeple Privacy Policy at <a href="/privacy-policy">www.smeeple.com/privacy-policy</a> for information on how Smeeple collects, uses and discloses information about you.</p>
                    ...
                    <p>Customers are responsible for selecting the right Expert for their needs. In making hiring decisions, Customers should review and investigate each Expert's self-reported credentials, education, and experience, as well as reviews from other Customers.</p>

                    <p>Smeeple controls and operates the Site from various locations in the United States and makes no representation that this website is accessible in all locations. Smeeple services may not be available in your location, and available services may vary among locations. In addition, Smeeple will attempt to deliver all correspondence sent via the Site's messaging system. Smeeple does not, however, guarantee delivery of all messages.</p>
                    ...
                    <ul>
                        <li>Defame, abuse, harass in any form, harm, stalk, threaten or otherwise violate the legal rights (including without limitation rights of privacy and publicity) of others;</li>

                        <li>Create, upload, post, send, receive or store any false, misleading, profane, defamatory, infringing, hateful, distasteful, obscene or unlawful topic, name, information, materials or content;</li>

                        <li>Use the Site for any purpose that is in violation of local, state, national, or international law, including without limitation wage/hour and working condition laws and regulations;</li>

                        <li>Create an account or accounts on the Site for fraudulent purposes, or for the purpose of misusing the Site, including without limitation misappropriating the Site or any information on the Site for your own commercial or pecuniary gain;</li>

                        <li>Upload files that contain software or other content that violates the rights of any third party, including without limitation intellectual property rights or rights of privacy or publicity;</li>

                        <li>Upload files that contain viruses, Trojan horses, worms, time bombs, spiders, cancel bots, corrupted files, or any other similar software, malware or content that may damage, interfere with, disrupt, impair, disable or otherwise overburden the operation of any device, computer system or network;</li>

                        <li>Take any action that would undermine any aspect of the Site;</li>

                        <li>Attempt to gain unauthorized access to the Site, other User accounts, or other device, computer system or networks connected to the Site;</li>

                        <li>Advertise or offer to sell any goods or services for any commercial purpose on the Site that are not appropriate or relevant to the Site;</li>

                        <li>Impersonate another person or allow any other person or entity to impersonate you or use your credentials to access the Site;</li>

                        <li>Post the same content repeatedly or spam - spamming is strictly prohibited;</li>

                        <li>Download, copy or transmit any file posted by another User that you know, or reasonably should know, cannot be legally published through the Site;</li>

                        <li>Access, download, or copy any information, content and/or materials from the Site through artificial means (including without limitation spiders, scrapers, hacking devices, computer programs, bots, web spoofing, URL rewriting or other such means);</li>

                        <li>Reproduce, duplicate, copy, sell, re-sell or exploit any information, materials or content on the Site; or</li>

                        <li>Restrict or inhibit any other User from using and enjoying the Site.</li>
                    </ul>

                    <p>Smeeple reserves all of its rights under the Communications Decency Act, including without limitation its right to remove anything objectionable to Smeeple in its sole discretion. Alleged improprieties by any User may be reported to Smeeple by email at <a href="mailto:support@smeeple.com">support@smeeple.com</a>.</p>
                    ...
                    <p>Smeeple may now or in the future allow Users to submit, post, display, provide, or otherwise make available content such as text, images, videos, files, documents, comments, questions, and other content or information (any such materials a User submits, posts, displays, provides, or otherwise makes available on the Site is referred to as "User Content").</p>

                    <p>We claim no ownership rights over User Content created by you. The User Content you create remains yours. By submitting, posting, displaying, providing, or otherwise making available any User Content on or through the Site, you expressly grant, and you represent and warrant that you have all rights necessary to grant, to Smeeple a royalty-free, sub-licensable, transferable, perpetual, irrevocable, non-exclusive, worldwide license to use, reproduce, modify, publish, list information regarding, edit, translate, distribute, syndicate, publicly perform, publicly display, and make derivative works of all such User Content in whole or in part, and in any form, media or technology, whether now known or hereafter developed, for use in connection with Smeeple's (and its successors' and affiliates') business, including without limitation for promoting and redistributing part or all of the Site (and derivative works thereof) in any media formats and through any media channels. You also hereby grant each User of the Site a non-exclusive license to access your User Content through the Site, and to use, reproduce, distribute, display and perform such User Content as permitted through the functionality of the Site and under this Agreement.</p>
                    ...
                    <p>Smeeple employs a third-party payment processor, Stripe. Users should become familiar with the <a href="https://stripe.com/legal/ssa" target="_blank">Stripe Service Agreement</a>. Users must pay all costs associated with the services through Stripe. These costs may include but are not limited to:</p>
                    ...
                    <p>Except as expressly authorized by Smeeple or by third-party content providers, you agree not to reproduce, modify, rent, lease, loan, sell, distribute, mirror, frame, republish, download, transmit, or create derivative works of the content of others, in whole or in part, by any means. You must not modify, de-compile, or reverse engineer any software Smeeple discloses to you, and you must not remove or modify any copyright or trademark notice, or other notice of ownership.</p>
                    ...
                    <p>If you believe in good faith that a notice of copyright infringement has been wrongly filed against you, the DMCA permits you to send us a counter-notice. Notices and counter-notices must meet the then-current statutory requirements imposed by the DMCA; see <a href="http://www.loc.gov/copyright" target="_blank">http://www.loc.gov/copyright</a> for details. Smeeple's agent for notice of claims of copyright or other intellectual property infringement can be reached at <a href="mailto:support@smeeple.com">support@smeeple.com</a>.</p>
                    ...
                    <p>Please note that this procedure is exclusively for notifying Smeeple that your copyrighted material has been infringed. The preceding requirements are intended to comply with Smeeple's rights and obligations under the DMCA, including 17 U.S.C. §512(c), but do not constitute legal advice. It may be advisable to contact an attorney regarding your rights and obligations under the DMCA and other applicable laws.</p>
                    ...
                    <p>You agree that Smeeple, in its sole discretion, may suspend or terminate your password, account (or any part thereof) or use of the Smeeple's services, for any reason, including, without limitation, for lack of use or if Smeeple believes that you have violated or acted inconsistently with the letter or spirit of this Agreement. You agree that any termination of your access to the Site and Smeeple's services under any provision of this Agreement may be implemented without prior notice, and you acknowledge and agree that Smeeple may immediately deactivate or delete your account and all data relating to your account and/or bar any further access to the Site and Smeeple's services. Further, you agree that Smeeple shall not be liable to you or any third party for any termination of your access to the Site and Smeeple's services.</p>
                    ...
                    <p class="uppercase">You understand and agree that Smeeple has no control over the acts or omissions of any User on or off the Site and that Smeeple makes no representations or warranties about the quality of the services provided by any User. You understand and agree that Smeeple is not responsible for the performance or conduct, whether on or off the Site, of any User. As such, Smeeple expressly disclaims, and each User expressly releases Smeeple from, any and all liability whatsoever for any controversies, claims, suits, injuries and/or damages arising from and/or in any way related to the Site, including without limitation any acts and/or omissions of Users on or off the Site.</p>
                    ...
                    <p class="text-16 italic">Last modified: June 5<sup>th</sup>, 2023</p>
                </div>
            </div>
        </div>
    </section>
